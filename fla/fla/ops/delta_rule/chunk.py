...
def chunk_delta_rule_bwd(
    ...
    # du for intra (quadratic) attention
    ...
    # the input dv, i.e. du is just added the part of du from FW k*W^T
    ...
    # dq has two parts: intra and inter attention
    # dh has three parts; two of them, analoguous to dq, are computed here.
    # dk has a third and last part below.
