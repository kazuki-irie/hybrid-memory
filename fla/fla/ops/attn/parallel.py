...
@triton.jit
def parallel_chunk_only_attn_fwd_kernel(
    q,
    k,
    v,
    o,
...
@triton.jit(do_not_specialize=['T'])
def parallel_chunk_only_attn_bwd_kernel_dq(
    q,
    k,
    v,
    lse,
...
@triton.jit(do_not_specialize=['T'])
def parallel_chunk_only_attn_bwd_kernel_dkv(
    q,
    k,
    v,
    g_cumsum,
...
def parallel_chunk_only_attn_fwd(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    g_cumsum: torch.Tensor,
    ...
    lse = torch.empty(B, T, HQ, dtype=torch.float, device=q.device)
    grid = (NV, NT, B * HQ)
    parallel_chunk_only_attn_fwd_kernel[grid](
        q=q,
        k=k,
        v=v,
        o=o,
...
def parallel_chunk_only_attn_bwd(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    o: torch.Tensor,
    ...
    parallel_chunk_only_attn_bwd_kernel_dq[grid](
        q=q,
        k=k,
        v=v,
        g_cumsum=g_cumsum,
    ...
    parallel_chunk_only_attn_bwd_kernel_dkv[grid](
        q=q,
        k=k,
        v=v,
        g_cumsum=g_cumsum,
