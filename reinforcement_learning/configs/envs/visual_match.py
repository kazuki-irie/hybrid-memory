...
def create_fn(config: ConfigDict) -> Tuple[ConfigDict, str]:
    ...
    register(
        ...
        kwargs=dict(
            ...
            apple_reward=1.0,
            num_apples=10,
            final_reward=config.final_reward,  # ORIGINAL: final reward 5
            respawn_every=config.respawn_every,  # ORIGINAL: apple respawn after 20 steps
            passive=True,
...
def get_config():
    ...
    config.final_reward = 100.0
    config.respawn_every = 20
